...
FEATURE_PRESENCE_TESTS_SCRIPTS = sorted([
    ...
    ("cs_138cdc", "function=Page_Load", Class("System.Diagnostics.ProcessStartInfo"), True),
    ("cs_138cdc", "function=Page_Load", API("System.Diagnostics.ProcessStartInfo::ctor"), True),
    ("cs_138cdc", "function=Page_Load", Class("System.Diagnostics.Process"), True),
    ("cs_138cdc", "function=Page_Load", API("System.Diagnostics.Process::ctor"), True),
    (
        "cs_138cdc",
        "function=Page_Load",
    ...
    ("aspx_4f6fa6", "function=do_ps", Class("System.Diagnostics.ProcessStartInfo"), True),
    ("aspx_4f6fa6", "function=do_ps", API("System.Diagnostics.ProcessStartInfo::ctor"), True),
    ...
    ("aspx_5f959f", "function=ExcuteCmd", Class("System.Diagnostics.ProcessStartInfo"), True),
    ("aspx_5f959f", "function=ExcuteCmd", API("System.Diagnostics.ProcessStartInfo::ctor"), True),
    ...
    ("aspx_10162f", "function=d", API("System.IO.File::Delete"), True),
    ("aspx_10162f", "function=sq", Class("System.Data.SqlClient.SqlConnection"), True),
    ("aspx_10162f", "function=sq", API("System.Data.SqlClient.SqlConnection::ctor"), True),
    ("aspx_10162f", "function=sq", Class("System.Data.SqlClient.SqlCommand"), True),
    ("aspx_10162f", "function=sq", API("System.Data.SqlClient.SqlCommand::ctor"), True),
    ("aspx_10162f", "function=sq", Class("System.Data.SqlClient.SqlDataAdapter"), True),
    ("aspx_10162f", "function=sq", API("System.Data.SqlClient.SqlDataAdapter::ctor"), True),
    ("aspx_10162f", "function=sq", API("System.Data.SqlClient.SqlConnection::Open"), True),
    ("aspx_10162f", "function=exec", Class("System.Diagnostics.Process"), True),
    ("aspx_10162f", "function=exec", API("System.Diagnostics.Process::ctor"), True),
    ...
    ("aspx_10162f", "function=exp", Class("System.IO.DirectoryInfo"), True),
    ("aspx_10162f", "function=exp", API("System.IO.DirectoryInfo::ctor"), True),
    ...
    ("aspx_2b71dd", "function=ExcuteCmd", Class("System.Diagnostics.ProcessStartInfo"), True),
    ("aspx_2b71dd", "function=ExcuteCmd", API("System.Diagnostics.ProcessStartInfo::ctor"), True),
    ...
    ("aspx_6f3261", "function=btnExecute_Click", Class("System.Data.SqlClient.SqlConnection"), True),
    ("aspx_6f3261", "function=btnExecute_Click", API("System.Data.SqlClient.SqlConnection::ctor"), True),
    ("aspx_6f3261", "function=btnExecute_Click", API("System.Data.SqlClient.SqlConnection::Open"), True),
    ("aspx_6f3261", "function=btnExecute_Click", Class("System.Data.SqlClient.SqlCommand"), True),
    ("aspx_6f3261", "function=btnExecute_Click", API("System.Data.SqlClient.SqlCommand::ctor"), True),
    ...
    ("aspx_1f8f40", "function=PSEUDO MAIN", Class("System.Security.Cryptography.RijndaelManaged"), True),
    ("aspx_1f8f40", "function=PSEUDO MAIN", API("System.Security.Cryptography.RijndaelManaged::ctor"), True),
    (
        "aspx_1f8f40",
    ...
    ("aspx_2e8c7e", "function=ExecuteCommand", Class("System.Diagnostics.ProcessStartInfo"), True),
    ("aspx_2e8c7e", "function=ExecuteCommand", API("System.Diagnostics.ProcessStartInfo::ctor"), True),
    ...
    ("aspx_03bb5c", "function=PSEUDO MAIN", Class("System.Diagnostics.ProcessStartInfo"), True),
    ("aspx_03bb5c", "function=PSEUDO MAIN", API("System.Diagnostics.ProcessStartInfo::ctor"), True),
    ...
    ("py_24e48f", "file", Format(FORMAT_SCRIPT), True),
    ("py_24e48f", "file", Namespace("socket"), True),
    ("py_24e48f", "file", Namespace("threading.Timer"), True),
    ("py_24e48f", "file", Namespace("threading.Timer"), True),
    ("py_24e48f", "function=icloud_phish", API("subprocess::Popen"), True),
    ("py_24e48f", "function=icloud_phish", Class("urllib2.Request"), True),
    ...
    ("py_24e48f", "function=get_itunes_backups", Number(1), True),
    ("py_a4d252", "file", Namespace("win32com.client"), True),
    ("py_a4d252", "file", Namespace("shutil"), True),
    ("py_a4d252", "function=PSEUDO MAIN", API("os::environ"), True),
    ("py_a4d252", "function=yut", API("shutil::copytree"), True),
    ("py_a4d252", "function=yut", API("os::getcwd"), True),
    ("py_a4d252", "function=takk", API("win32com.client::Dispatch"), True),
    ("py_a4d252", "function=takk", String("Schedule.Service"), True),
    ("py_a4d252", "function=takk", Substring("Updatewmplayer.exe"), True),
    ("py_a4d252", "function=llp", API("win32api::SetFileAttributes"), True),
    ("py_a4d252", "function=llp", Substring("KMPlayer"), True),
    ("py_a4d252", "function=fop", API("os::remove"), True),
    ("py_a4d252", "function=fop", Substring("Projec.exe"), True),
    ("py_a4d252", "function=htr", API("time::sleep"), True),
    ("py_a4d252", "function=htr", Number(30), True),
    ("py_a4d252", "function=htr", Number(25), True),
    ("py_a4d252", "function=htr", Number(10), True),
    ("py_a4d252", "function=vul", Number(5), True),
    ("py_a4d252", "function=vul", Number(1), True),
    ("py_a4d252", "function=vul", API("os::popen"), True),
